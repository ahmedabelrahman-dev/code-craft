...
function RunButton() {
  ...
  const handleRun = async () => {
    ...
    console.log("RunButton - User:", user?.id, "IsSignedIn:", isSignedIn);
    console.log("RunButton - Execution result:", result ? {
      hasCode: !!result.code,
    ...
    if (!result) {
      console.log("No execution result available, skipping save");
      return;
    }
    ...
    try {
      ...
      console.log("Execution save completed:", saved);
    } catch (error) {
